...
/*
 * The Material class defines the optical properties of an object, such as its
 * color, dullness, shininess, reflectance, ect... It is used along side a shader
 * program to calculate final coloring of models and their textures.
 */
